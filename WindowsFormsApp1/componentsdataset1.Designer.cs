...
namespace WindowsFormsApp1 {
    ...
    public partial class componentsdataset : global::System.Data.DataSet {
        ...
        public partial class componentsDataTable : global::System.Data.TypedTableBase<componentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public componentsRow AddcomponentsRow(string name, string description, int quantity, System.DateTime arrival_date) {
...
namespace WindowsFormsApp1.componentsdatasetTableAdapters {
    ...
    public partial class componentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[components] ([name], [description], [quantity], [arrival_date]" +
                ") VALUES (@name, @description, @quantity, @arrival_date);\r\nSELECT id, name, desc" +
                "ription, quantity, arrival_date FROM components WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[components] SET [name] = @name, [description] = @description, [quantity] = @quantity, [arrival_date] = @arrival_date WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)) AND ((@IsNull_arrival_date = 1 AND [arrival_date] IS NULL) OR ([arrival_date] = @Original_arrival_date)));
SELECT id, name, description, quantity, arrival_date FROM components WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, description, quantity, arrival_date FROM dbo.components";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_description, global::System.Nullable<int> Original_quantity, global::System.Nullable<global::System.DateTime> Original_arrival_date) {
        ...
        public virtual int Insert(string name, string description, global::System.Nullable<int> quantity, global::System.Nullable<global::System.DateTime> arrival_date) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string description, global::System.Nullable<int> quantity, global::System.Nullable<global::System.DateTime> arrival_date, int Original_id, string Original_name, string Original_description, global::System.Nullable<int> Original_quantity, global::System.Nullable<global::System.DateTime> Original_arrival_date, int id) {
            if ((name == null)) {
            ...
            if ((Original_arrival_date.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((System.DateTime)(Original_arrival_date.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string description, global::System.Nullable<int> quantity, global::System.Nullable<global::System.DateTime> arrival_date, int Original_id, string Original_name, string Original_description, global::System.Nullable<int> Original_quantity, global::System.Nullable<global::System.DateTime> Original_arrival_date) {
            return this.Update(name, description, quantity, arrival_date, Original_id, Original_name, Original_description, Original_quantity, Original_arrival_date, Original_id);
        }
    }
